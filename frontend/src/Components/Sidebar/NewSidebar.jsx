...
>
  {isSidebarVisible ? (
    ...
    <CgMenuRound className='text-2xl text-gray-200' />
        ...
        <div className={`sm:hidden mt-0 md:fixed lg:fixed flex  md:block lg:block sm:w-28 md:w-52 lg:w-52 w-42 h-full bg-sky-900 text-white border-r-4 border-gray-700 ${isSidebarVisible ? 'block' : 'hidden'}`}>
